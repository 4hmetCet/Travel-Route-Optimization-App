...
public class OfflineMapActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private void downloadRegion(final String regionName) {
        ...
        map.getStyle(new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                float pixelRatio = OfflineMapActivity.this.getResources().getDisplayMetrics().density;
